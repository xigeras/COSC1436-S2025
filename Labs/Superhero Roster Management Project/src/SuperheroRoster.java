...
public class SuperheroRoster {
    ...
    public static void main(String[] args) {
        ...
        // 5. Sort and display heroes by power level using sortAndDisplayByPower method
        System.out.println("---------------------------------");
    ...
    public static void sortAndDisplayByPower(Superhero[] heroes) {
        // Implement sorting logic based on power level
        // Display the sorted heroes
        Arrays.sort(heroes, (a, b) -> Integer.compare(b.getPowerLevel(), a.getPowerLevel()));
